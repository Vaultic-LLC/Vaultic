...
export default defineComponent({
    ...
    setup()
    {
        ...
        const currentColor: ComputedRef<string> = computed(() => stores.userPreferenceStore.currentPrimaryColor.value);
        ...
        watch(() => stores.userPreferenceStore.currentPrimaryColor.value, (newValue) =>
        {
            if (!colorObject)
            {
                return;
