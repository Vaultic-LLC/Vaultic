<template>
	<div class="groupSelector">
		<div class="groupButtons">
			<div class="groupButton" v-for="(group, index) in groups" :key="index" @click="tableRowDatas[index].onClick()">
...
export default defineComponent({
	...
	setup(props, ctx)
	{
		...
		const color: ComputedRef<string> = computed(() => stores.settingsStore.currentColorPalette.groupsColor);
