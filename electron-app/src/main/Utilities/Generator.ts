...
export function generateRandomPasswordOrPassphrase(type: RandomValueType, length: number, includeNumbers: boolean, includeSpecialCharacters: boolean,
...
const generatorUtility: GeneratorUtility =
{
	...coreGenerator,
	uniqueId,
	generateRandomPasswordOrPassphrase,
	publicPrivateKey
};
