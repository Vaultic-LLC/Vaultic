...
{
    // TODO: won't this get overriden by the methods below? That probably isn't a big deal since dataToBackup is only applied 
    // if we are re backing up so there can't be any new changes, but still kind of wack
