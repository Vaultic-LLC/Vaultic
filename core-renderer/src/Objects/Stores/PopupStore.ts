...
export function createPopupStore()
{
    ...
    return {
        ...
        get organizationPopupIsShowing() { return vaultPopupIsShowing.value; },
        get organizationModel() { return vaultModel.value },
        get onOrganizationPopupClose() { return onVaultPopupClose.value; },
        addOnEnterHandler,
